...
# Push tags to Gitea Microlab
push-tags-gitea-microlab:
...
# Push tags to Gitea (nexus-lab instance)
push-tags-gitea-nexus-lab:
...
# Force-sync Gitea Microlab with GitHub (overwrite with origin state)
sync-gitea-microlab:
